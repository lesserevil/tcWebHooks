...
public class TestingMockUser implements User {
	...
	@Override
	public Permissions getPermissionsGrantedForAnyOfProjects(java.util.Collection<java.lang.String> projectIds) {
		return new Permissions();
	}

	@Override
	public boolean isPermissionGrantedForAnyOfProjects(java.util.Collection<java.lang.String> projectIds, Permission permission) {
		return false;
	}
